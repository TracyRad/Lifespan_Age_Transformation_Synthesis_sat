...
class BaseOptions():
    ...
    def initialize(self):
        ...
        #trying to chang the age range so that it is lower 
        self.parser.add_argument('--sort_order', type=str, default='7-9,9-14,15-19,20-29,30-39,40-49', help='a specific order to sort the classes, must contain all classes, only works when sort_classes is true')
